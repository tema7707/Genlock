...
from nft_deployer.pyfift.core.contract import Contract
...
class WalletV3R2(Contract, WalletBase):
    ...
    def init_data(self, pub_key: bytes = None):
    ...
    def build_message(self, sub_wallet: int, valid_until: int, seq_no: int, message: bytes, message_mode: int = 64):
